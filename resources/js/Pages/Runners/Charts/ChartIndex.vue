<script setup>
import DistanceChart from '@/Pages/Runners/Charts/DistanceChart.vue'
import RaceChart from '@/Pages/Runners/Charts/RaceChart.vue'
import CompareByTagChart from '@/Pages/Runners/Charts/CompareByTagChart.vue'
