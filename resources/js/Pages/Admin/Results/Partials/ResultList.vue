...
<template>
    <div class="relative w-full overflow-x-scroll lg:overflow-x-hidden">
        <div class="grid grid-cols-11 gap-2 md:gap-4 border-b min-w-800 text-center">
            ...
            <div class="col-span-2 font-bold p-2">{{ $t('result.time') }}</div>
        ...
        <div v-for="(result, index) in results" :key="result.id" class="grid grid-cols-11 gap-2 md:gap-4 hover:bg-gray-100 min-w-800 text-center"
            ...
            <div class="col-span-2 p-2">{{ result.time }}</div>
