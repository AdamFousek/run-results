            ...
            <nav class="bg-white border-b border-gray-100">
                    ...
                    <div class="flex justify-between h-16">
                        <div class="flex">
                            ...
                            <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                                <NavLink :href="route('admin.runners.index')"
                                         :active="route().current('admin.runners.*')">
                                    {{ $t('menu.runners') }}
                                </NavLink>
                                ...
                                <NavLink :href="route('admin.measurement.index')"
                                         :active="route().current('admin.measurement.*')">
                                    {{ $t('menu.measurement') }}
                                </NavLink>
                            </div>
                        </div>
                ...
                >
                    <div class="pt-2 pb-3 space-y-1">
                        ...
                        <ResponsiveNavLink :href="route('admin.races.index')"
                                           :active="route().current('admin.races.*')">
                            {{ $t('menu.races') }}
                        </ResponsiveNavLink>
                        ...
                        <ResponsiveNavLink :href="route('admin.results.index')"
                                           :active="route().current('admin.results.*')">
                            {{ $t('menu.results') }}
                        </ResponsiveNavLink>
                    </div>
